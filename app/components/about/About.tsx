...
const About = () => {
    return (
        <Container>
            <div className='flex flex-col items-center gap-5 pt-72 pb-32 md:pt-48 lg:pt-48'>
                <h1 className='max-w-2xl mb-4 text-4xl text-black text-center font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl'>Bienvenido a Informula</h1>
