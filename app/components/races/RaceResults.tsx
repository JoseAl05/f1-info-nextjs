...
const RaceResults: React.FC<RaceResultsProps> = async ({ results }) => {
    ...
    const driverId = results.driverId;
    const constructorId = results.constructorId;
    ...
    return (
        <div className='flex flex-col items-center'>
            ...
            <p className='text-white text-lg font-semibold border-x border-t bg-[#2d4b80] p-1'>{constructor.team!.name}</p>
